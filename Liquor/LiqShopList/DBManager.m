...
- (void)createCopyOfDatabaseIfNeeded
{
    ...
    NSString *appDBPath = [[NSString alloc] initWithString:[documentsDirectory stringByAppendingPathComponent:@"dbTaxicab.db"]];
    ...
    NSString *defaultDBPath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"dbTaxicab.db"];
...
-(NSMutableArray *)readInformationFromDatabase_tblReserve:(NSString*) tableName
{
    ...
    databasePath = [documentPath stringByAppendingPathComponent:@"dbTaxicab.db"];
